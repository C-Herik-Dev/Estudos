...
export function Detail() {
  ...
  useEffect(() => {
    async function getCoin(){
      try{
        fetch(`https://rest.coincap.io/v3/assets/${cripto}?apiKey=7d783cf95c1901061031fb0e4a4f0b8e63b307129df218fb35846ca8920ebbc6`)
    ...
    <div className={styles.container}>
      ...
      <section className={styles.content}>
        <img
           ...
           src={`https://assets.coincap.io/assets/icons/${coin?.symbol.toLocaleLowerCase()}2@2x.png` && `https://assets.coincap.io/assets/icons/${coin?.symbol.toLocaleLowerCase()}@2x.png` }
          />
